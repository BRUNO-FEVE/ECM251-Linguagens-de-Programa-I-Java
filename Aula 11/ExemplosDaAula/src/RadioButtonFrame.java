...
// Criando botıes de opÁ„o utilizando ButtonGroup e JRadioButton.
...
{
   private JTextField textField; // utilizado para exibir alteraÁıes de fonte
   ...
   private ButtonGroup radioGroup; // buttongroup para armazenar botıes de opÁ„o
   ...
   public RadioButtonFrame()
   {
      ...
      // cria relacionamento lÛgico entre JRadioButtons
   ...
   // classe interna private para tratar eventos de bot„o de opÁ„o
   private class RadioButtonHandler implements ItemListener
   {
      ...
      // trata eventos de bot„o de opÁ„o

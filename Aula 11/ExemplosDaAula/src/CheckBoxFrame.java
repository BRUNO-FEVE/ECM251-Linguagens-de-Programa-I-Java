...
{
   private JTextField textField; // exibe o texto na alteraÁ„o de fontes
   ...
   public CheckBoxFrame()
   {
      ...
      boldJCheckBox = new JCheckBox( "Bold" ); // cria caixa de seleÁ„o p/ negrito
      italicJCheckBox = new JCheckBox( "Italic" ); // cria it·lico
      add( boldJCheckBox ); // adiciona caixa de seleÁ„o de negrito ao JFrame
      add( italicJCheckBox ); // adiciona caixa de seleÁ„o de it·lico ao JFrame
   ...
   private class CheckBoxHandler implements ItemListener
   {
      ...
      // responde aos eventos de caixa de seleÁ„o
      public void itemStateChanged( ItemEvent event )
      {
         // processa eventos da caixa de seleÁ„o de negrito
         if (event.getSource() == boldJCheckBox)
            valBold = 
               boldJCheckBox.isSelected()? Font.BOLD : Font.PLAIN;
               
         // processa eventos da caixa de seleÁ„o de it·lico

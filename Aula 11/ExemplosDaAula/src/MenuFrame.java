...
public class MenuFrame extends JFrame 
{
   ...
   public MenuFrame()
   {
      ...
      fileMenu.setMnemonic( 'F' ); // configura o mnemÙnico como F        

      // cria item de menu About... 
      JMenuItem aboutItem = new JMenuItem( "About..." );       
      aboutItem.setMnemonic( 'A' ); // configura o mnemÙnico com A       
      fileMenu.add( aboutItem ); // adiciona o item about ao menu File
      aboutItem.addActionListener(

         new ActionListener() // classe interna anÙnima
         {  
         ...
         } // fim da classe interna anÙnima
      ); // fim da chamada para addActionListener
 
      JMenuItem exitItem = new JMenuItem( "Exit" ); // cria o item exit
      exitItem.setMnemonic( 'x' ); // configura o mnemÙnico como x                
      ...
      formatMenu.setMnemonic( 'r' ); // configura o mnemÙnico como r            

      // array listando cores de string
      String colors[] = { "Black", "Blue", "Red", "Green" };

      JMenu colorMenu = new JMenu( "Color" ); // cria o menu Color
      colorMenu.setMnemonic( 'C' ); // configura o mnemÙnico como C          

      // cria itens do menu Color com botıes de opÁ„o
      ...
      // criar itens do menu Style com caixas de seleÁ„o
      ...
      // configura o rÛtulo para exibir texto
   ...
   // classe interna para tratar eventos de aÁ„o dos itens de menu
   private class ItemHandler implements ActionListener 
   {
     // processa seleÁıes de cor e fonte
      public void actionPerformed( ActionEvent event )
      {
         // processa a seleÁ„o de cor
   ...
   // classe interna para tratar eventos dos itens de menu com caixa de seleÁ„o
   private class StyleHandler implements ItemListener 
   {
      // processa seleÁıes de estilo da fonte
      public void itemStateChanged( ItemEvent e )
      {
         ...
         repaint(); // redesenha o aplicativo
      } // fim do mÈtodo itemStateChanged
